...
Gem::Specification.new do |s|
  ...
  s.required_ruby_version = Gem::Requirement.new(["< 2.4".freeze, "~> 2.2".freeze])
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<hashicorp-checkpoint>.freeze, ["~> 0.1.1"])
      ...
      s.add_development_dependency(%q<fake_ftp>.freeze, ["~> 0.1"])
    else
      ...
      s.add_dependency(%q<hashicorp-checkpoint>.freeze, ["~> 0.1.1"])
      ...
      s.add_dependency(%q<fake_ftp>.freeze, ["~> 0.1"])
    end
  else
    s.add_dependency(%q<childprocess>.freeze, ["~> 0.6.0"])
    s.add_dependency(%q<erubis>.freeze, ["~> 2.7.0"])
