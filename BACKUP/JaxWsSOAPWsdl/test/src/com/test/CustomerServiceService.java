 ...
 * 
 */
@WebServiceClient(name = "CustomerServiceService", targetNamespace = "http://test.com/", wsdlLocation = "http://localhost:8080/test/customerService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CUSTOMERSERVICESERVICE_QNAME = new QName("http://test.com/", "CustomerServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/test/customerService?wsdl");
    ...
    public CustomerService getCustomerServicePort() {
        return super.getPort(new QName("http://test.com/", "CustomerServicePort"), CustomerService.class);
    }
    ...
    public CustomerService getCustomerServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://test.com/", "CustomerServicePort"), CustomerService.class, features);
    }
