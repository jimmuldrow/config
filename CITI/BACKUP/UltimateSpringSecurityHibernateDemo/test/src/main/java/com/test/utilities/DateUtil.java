...
public class DateUtil {
	...
	public static LocalDate setMdyDate(String mdyDate){
	...
	public static LocalDate setDmyDate(String dmyDate){
	...
	public static LocalDate setYmdDate(String ymdDate){
	...
	public static LocalDate setDate(int y, int m, int d){
		if((y > 1500) && (y < 2500)){
			try{
	...
	public static LocalDate addDays(LocalDate start, int daysAdded){
		 return start.plus(daysAdded, ChronoUnit.DAYS);
	}
	
	public static LocalDate addWeeks(LocalDate start, int weeksAdded){
		 return start.plus(weeksAdded, ChronoUnit.WEEKS);
	}
	
	public static LocalDate addMonths(LocalDate start, int monthsAdded){
		 return start.plus(monthsAdded, ChronoUnit.MONTHS);
	}	
	
	public static LocalDate addYears(LocalDate start, int yearsAdded){
		 return start.plus(yearsAdded, ChronoUnit.YEARS);
	}	
	
	public static long getPeriodInDays(LocalDate date1, LocalDate date2){
	...
	public static String internationalDate(LocalDate localDate, Locale locale, FormatStyle formatStyle){
		try{
	...
	private static String noNull(String s){return ((s == null) ? "" : s.trim());}	
